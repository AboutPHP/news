...
//则代码段运行后返回 API_RETURN_SUCCEED，否则返回 API_RETURN_FORBIDDEN。接口运行失败则返回 API_RETURN_FAILED。
define('API_RETURN_SUCCEED', '1');
define('API_RETURN_FAILED', '-1');
define('API_RETURN_FORBIDDEN', '-2');
define('DISCUZ_ROOT',dirname(dirname(dirname(__FILE__))).'/extend/uc/ucapi');
//note 普通的 http 通知方式
if(!defined('IN_UC')) {
...
class uc_note {
	...
	function synlogin($get, $post) {
		...
		_setcookie('Example_auth', _authcode($uid."\t".$username."\t".$guid, 'ENCODE'));
	}
